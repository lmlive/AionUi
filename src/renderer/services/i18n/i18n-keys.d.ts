...
export type I18nKey =
  ...
  | 'settings.about'
  | 'settings.acpModelNotAvailable'
  | 'settings.acpModelPreference'
  | 'settings.acpModelPreferenceDesc'
  | 'settings.acpModelSelectPlaceholder'
  ...
  | 'team.create.teammates'
  | 'team.create.teammatesDesc'
  | 'team.create.teammatesPlaceholder'
  | 'team.create.title'
  ...
  | 'team.removeAgent.rateLimited'
  | 'team.removeAgent.retryFailed'
  | 'team.removeAgent.retrying'
